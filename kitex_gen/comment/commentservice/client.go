...
type Client interface {
	...
	DeleteComment(ctx context.Context, req *comment.DeleteCommentRequest, callOptions ...callopt.Option) (r *user.BaseResp, err error)
...
func (p *kCommentServiceClient) DeleteComment(ctx context.Context, req *comment.DeleteCommentRequest, callOptions ...callopt.Option) (r *user.BaseResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
